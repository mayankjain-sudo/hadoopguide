...
public class IntroductionFragment extends Fragment {
    ...
    class SimpleAdapter extends RecyclerView.Adapter<SimpleHolder> {
        ...
        public int getItemCount() {
            return DataProvider.INTRO_DATA_HEADING.length;
        }
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos >= 0 && pos < getItemCount()) {
                       // Toast.makeText(getContext(), DataProvider.INTRO_DATA_HEADING[pos], Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        public void onBindViewHolder(SimpleHolder simpleHolder, int i) {
            simpleHolder.mHeadingTextView.setText(DataProvider.INTRO_DATA_HEADING[i]);
            simpleHolder.mTextView.setText(DataProvider.INTRO_DATA_BRIEF[i]);
