...
import static mayank.jain.hadoopguide.others.DataProvider.*;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link MachineSetupFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MachineSetupFragment#newInstance} factory method to
...
public class MachineSetupFragment extends Fragment {
     ...
     * @return A new instance of fragment MachineSetupFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MachineSetupFragment newInstance(String param1, String param2) {
        MachineSetupFragment fragment = new MachineSetupFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_machine_setup, container, false);
    ...
    class SimpleAdapter extends RecyclerView.Adapter<SimpleHolder> {
        ...
        public int getItemCount() {
            return MACHINE_DATA_HEADING.length;
        }
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos >= 0 && pos < getItemCount()) {
                      //  Toast.makeText(getContext(), MACHINE_DATA_HEADING[pos], Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        public void onBindViewHolder(SimpleHolder simpleHolder, int i) {
            ...
            simpleHolder.mTextView.setText(MACHINE_DATA_BRIEF[i]);
            simpleHolder.mTextViewHeading.setText(MACHINE_DATA_HEADING[i]);

            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) { //>= API 21
                simpleHolder.mImageView.setImageDrawable(getResources().getDrawable(MACHINE_DATA_IMAGE[i],getContext().getTheme()));

                //myImgView.setImageDrawable(getResources().getDrawable(R.drawable.myimage, getApplicationContext().getTheme()));
            } else {
                //myImgView.setImageDrawable(getResources().getDrawable(R.drawable.myimage));
                simpleHolder.mImageView.setImageDrawable(getResources().getDrawable(MACHINE_DATA_IMAGE[i]));
            }
